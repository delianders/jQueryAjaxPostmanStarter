// this life updates the copyright year in the footer
(function(){
	let now = new Date();
...
// $.get("https://6f186305-ab26-4839-b806-380e3560e049.mock.pstmn.io/cupcakes.json", displayCupcakes, function(response){
//   console.log(response);
//   displayCupcakes(response);
